...
class LSegEnc(BaseModel):
    ...
    def forward(self, x, labelset):
        ...
        text = text.to(x.device)
        self.logit_scale = self.logit_scale.to(x.device)
        text_features = self.clip_pretrained.encode_text(text) # TODO Difference between this and clip.tokenize
        ...
        logits_per_image = pixel_encoding.float() @ text_features.t()
